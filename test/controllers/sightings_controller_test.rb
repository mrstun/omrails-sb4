...
class SightingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post sightings_url, params: { sighting: { address: @sighting.address, comments: @sighting.comments, latitude: @sighting.latitude, longitude: @sighting.longitude, user_id: @sighting.user_id } }
    end
  ...
  test "should update sighting" do
    patch sighting_url(@sighting), params: { sighting: { address: @sighting.address, comments: @sighting.comments, latitude: @sighting.latitude, longitude: @sighting.longitude, user_id: @sighting.user_id } }
